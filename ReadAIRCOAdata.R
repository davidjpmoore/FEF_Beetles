...
FEFACO = read.table("AIRCOA//rdNCAR_FEF_most_recent.lin03312015" ,header=TRUE, stringsAsFactors = FALSE)

SPLACO = read.table("AIRCOA//rdNCAR_SPL_most_recent.lin03312015" ,header=TRUE, stringsAsFactors = FALSE)
